...
class UserModule extends CWebModule {
  ...
  public $controllerMap=array(
    'default'=>array('class'=>'user.controllers.YumDefaultController'),
    'rest'=>array('class'=>'user.controllers.YumRestController'),
    'csv'=>array('class'=>'user.controllers.YumCsvController'),
    'auth'=>array('class'=>'user.controllers.YumAuthController'),
    'install'=>array('class'=>'user.controllers.YumInstallController'),
    'statistics'=>array('class'=>'user.controllers.YumStatisticsController'),
    'translation'=>array('class'=>'user.controllers.YumTranslationController'),
    'user'=>array('class'=>'user.controllers.YumUserController'),
    // workaround to allow the url application/user/login:
    'login'=>array('class'=>'user.controllers.YumUserController')
  );
